...
<head>
    ...
    <title>403 — Không có quyền truy cập | KTX System</title>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #1a0533 0%, #3b1268 50%, #1e0a3c 100%);
            margin: 0;
            padding: 2rem 1rem;
    ...
    <div class="error-page">
        <div class="error-content">
            ...
            <p class="error-message">
                <?= htmlspecialchars($errorMessage ?? 'Bạn không có quyền truy cập vào trang này. Vui lòng liên hệ quản trị viên nếu bạn cho rằng đây là nhầm lẫn.') ?>
            </p>
